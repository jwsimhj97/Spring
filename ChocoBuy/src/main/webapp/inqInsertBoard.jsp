...
<body>
	<div class="container boardListBox">
		...
		<form action="inqInsertBoard.do" method="post" enctype="multipart/form-data">
			<table class="writeBox">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="file" name="inq_UploadFile">
						</td>
					</tr>
					<tr>
						<td colspan="2">
		...
		<div class="btnBox">
			<a class="blackBtn" href="inqGetBoardList.do">글 목록 가기</a>
		</div>
	</div>
</body>
</html>