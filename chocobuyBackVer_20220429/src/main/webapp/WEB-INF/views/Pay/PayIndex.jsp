...
// 				geocoder.addressSearch('${app.app_add }', function(result, status) {
...
<%-- 			</c:forEach> --%>
			...
			<td>
				...
				<!-- 년,월,일,시 텍스트박스 통합할지 생각해야 함 -->
				<input type="text" size="3" id="pay_year" value="" readonly/>년 <input type="text" size="2" id="pay_month" value="" readonly/>월 <input type="text" size="2" id="pay_day" value="" readonly/>일<br>
				<input type="text" size="1" id="pay_start_time" value="" readonly/>시 ~ <input type="text" size="1" id="pay_end_time" value="" readonly/>시
<%-- 				<c:forEach items="${AppointmentList }" var="app"> --%>
<%-- 					<input type="text" size="20" id="pay_date" value="${appointment.app_created }, ${appointment.app_time }" readonly/> --%>
<%-- 				</c:forEach> --%>
			</td>
		</tr>
		<tr>
			<td>
				...
				판매자&nbsp;&nbsp;&nbsp;&nbsp;: <input type="text" size="4" id="pay_seller" value="" readonly/> 구매자: <input type="text" size="4" id="pay_buyer" value="" readonly/><br>
				거래내용: <input type="text" size="30" id="pay_trade" value="" readonly/>
...
<%-- 				</c:forEach> --%>
		...
		<tr>
			<td>
				...
				<input type="text" size="30" id="pay_amount" value="" readonly/>원
<%-- 				<c:forEach items="${AppointmentList }" var="app">		 --%>
